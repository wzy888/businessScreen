...
public class BleManager {
     ...
     * @return
     */
    public BluetoothGatt connect(final String mac, BleGattCallback bleGattCallback) {
        ...
        BleLog.d("connectByMac : "+bleDevice.toString());
        return connect(bleDevice, bleGattCallback);
    }

    public BluetoothGatt connectByMac(final String mac, BleGattCallback bleGattCallback) {
//        BluetoothDevice bluetoothDevice = getBluetoothAdapter().getRemoteDevice(mac);
//        BleDevice bleDevice = new BleDevice(bluetoothDevice, 0, null, 0);
//        BleLog.d("connectByMac : "+bleDevice.toString());
//        return connect(bleDevice, bleGattCallback);
           scan(new BleScanCallback() {
               ...
               public void onLeScan(BleDevice bleDevice) {
                   ...
                   if (bleDevice!=null){
                       String mac1 = bleDevice.getMac();
                       BleLog.d("获取的MAc"+ mac1 +"\n"+" - "+mac);
