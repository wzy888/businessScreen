 ...
 * ViewPager滑动动画效果
 */
public abstract class BaseHorizontalTransformer implements PageTransformer {
    ...
    /**
     * Indicates if the default_banner animations of the view pager should be used.
     *
     * @return
     */
     ...
     * <p>
     * The default_banner implementation attempts to reset all view properties. This is useful when toggling transforms that do
